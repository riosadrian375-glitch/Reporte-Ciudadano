<?php
$contactos = EmergenciaContacto::listar();
?>
<section class="page-header">
    <div class="container">
        <h1 class="page-title">Contactos de Emergencia</h1>
        <p class="page-subtitle">Directorio de emergencias de Arequipa</p>
    </div>
</section>
<section class="page-content">
    <div class="container">
        ...
        <div class="emergencias-nota">
            <p><strong>Importante:</strong> Para emergencias graves, llama directamente al <a href="tel:105">105 (Policia)</a> o <a href="tel:116">116 (Bomberos)</a>.</p>
        </div>
    </div>
</section>
